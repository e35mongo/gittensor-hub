 ...
 *
 * Self-contained copy mirroring `repositories/_lib/squarify.ts` so the miners
 * feature folder stays standalone. Packs weighted segments into a containing
 * rectangle with low aspect-ratio variance — cleaner than slice-and-dice when
 * the input distribution is uneven (miner earnings are heavily long-tailed). */
